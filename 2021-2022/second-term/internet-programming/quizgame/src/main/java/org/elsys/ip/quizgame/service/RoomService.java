...
import org.elsys.ip.quizgame.error.RoomInvalidNameLengthException;
...
public class RoomService {
    ...
    public RoomDto createRoom(RoomDto roomDto) throws RoomAlreadyExistsException, RoomInvalidNameLengthException {
        ...
        if (roomDto.getName().length() < 5) {
            throw new RoomInvalidNameLengthException("The room name must be more than 4 characters");
        }
